...
namespace MyProtocol.Constant
{
    public class CardType
    {
        ...
        public const int STRAIGHT = 3; // 34567
        public const int DOUBLE_STRAIGHT = 4; // 44 55 66
        public const int TRIPLE_STRAIGHT = 5; // 444 555 666
        public const int THREE = 6; // 444
        public const int THREE_ONE = 7; // 444 5
        public const int THREE_TWO = 8; // 444 55
        public const int BOOM = 9; // 4444
